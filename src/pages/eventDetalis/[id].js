...
import { IoHeartOutline, IoArrowBackCircleSharp, IoHeartDislike } from "react-icons/io5";
    ...
    >
      ...
      <Box textAlign="center" paddingY={4}>
        ...
        <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
          ...
          <Icon as={fav?FaHeart:FaRegHeart} w={6} h={6} color="red.400" cursor={"pointer"} onClick={()=>addToFavorites(images.docid)}/>
        </Box>
      </Box>
      ...
      {/* Event Details */}
      <Box paddingX={5} my={4} display={"flex"} flexDirection={"column"} gap={4}>
        <Box display={"flex"} gap={5}>
          <Text color="#f9cf58" fontWeight="bold">
            Event Name:
          </Text>
          <Text color="white">{images?.title || "Loading..."}</Text>
        </Box>
